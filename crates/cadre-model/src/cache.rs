//! Content-addressed build cache under `.cadre/cache/`.
...
/// Cache key inputs (FR-105): source + params + cadre + kernel versions.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CacheKey {
    pub source_sha256: HashHex,
    pub params_sha256: HashHex,
    pub cadre_version: String,
...
impl CacheKey {
    pub fn from_source(
        source: &str,
        params_json: &str,
        cadre_version: impl Into<String>,
        ...
        Self {
            ...
            cadre_version: cadre_version.into(),
...
impl BuildCache {
    /// Open or create a cache at `root` (typically `<project>/.cadre/cache`).
