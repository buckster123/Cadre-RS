...
| 17 | Live OCCT STEP e2e | optional local | **amber** | box/union green; **cut aborts** on host (see occt-depth.md) |
...
| 21 | OCCT live topology inspect | faces/normals from B-rep | **green** | `topology_snapshot` + box thickness test |
