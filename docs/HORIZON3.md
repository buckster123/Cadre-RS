...
**Default next if “cook on” with no pref:** **H3-1 Honesty pass.**

---

## 7. Checklist

- [ ] **H3-1** Honesty pass (cone + fences + truck naming)  
- [ ] **H3-2** Live harness frontier score  
- [ ] **H3-3** MCP surface depth  
