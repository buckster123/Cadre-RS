...
1. **OCCT depth** — topology wiring for inspect; parity goldens beyond mock volumes
   *(in progress / partial: live topology + inspect --kernel occt; cut boolean host-broken)*
...
8. **OCCT cut fix** — BRepAlgoAPI_Cut StdFail_NotDone on host (see docs/occt-depth.md)
